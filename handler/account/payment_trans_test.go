...
func TestQueryAccountPaymentDetail(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			got, err := QueryAccountPaymentDetail(tt.args.userId, tt.args.asePrivateKey, tt.args.userPrivateKey, tt.args.bthNbr, tt.args.autStr, tt.args.rtnStr, tt.args.ctnKey)
...
func TestQueryAccountPaymentTransInfo(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			got, err := QueryAccountPaymentTransInfo(tt.args.userId, tt.args.asePrivateKey, tt.args.userPrivateKey, tt.args.begDat, tt.args.endDat, tt.args.autStr, tt.args.rtnStr)
			if (err != nil) != tt.wantErr {
